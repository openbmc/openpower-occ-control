...
// Get the object path and service for an interface
std::string getSubtree(const std::string& interface, std::string& path,
                       std::string& service)
{
    ...
    {
        log<level::ERR>(
            fmt::format("util::getSubtree: Failed getSubTree({},0,{})",
